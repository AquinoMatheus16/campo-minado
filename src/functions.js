...
export const hadExplosion = board => fields(board)
...
export const showMines = board => fields(board).filter(field => field.mined)
...
export const flagsUsed = board => fields(board)
